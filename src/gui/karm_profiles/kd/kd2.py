"""KD2 karm-profil: L-profil med listverk kun på framside (som SD2, men 80mm listverk)."""

from ..base import KarmProfile


class KD2Profile(KarmProfile):
    """KD2: list (80mm bred, 7mm tykk) kun på framside, fast dybde 104mm.
