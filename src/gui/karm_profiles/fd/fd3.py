"""FD3 karm-profil: Smygmontasje, sentrert i vegg (som SD3/ID, men 60mm blad)."""

from ..base import KarmProfile


class FD3Profile(KarmProfile):
    """FD3 smygmontasje: utan listverk, sentrert i veggdjupna.

    Profil (frå karmkant innover):
      body (26mm) | kobling (5mm) | anslag (20mm bak blad)
    Totalt sidestolpe = 46mm.  Karmdybde 112mm sentrert i vegg.
    """

    def build_frame_parts(self, door, kb, kh, wall_t, karm_depth, sidestolpe_w):
        anslag_w = 20
        kobling_t = 5
        body_w = sidestolpe_w - anslag_w  # 46 - 20 = 26mm
        ...
        anslag_d = karm_depth - blade_t  # 112 - 60 = 52
