"""FD1 karm-profil: U-profil med listverk på begge sider av veggen (som KD1)."""

from ..base import KarmProfile


class FD1Profile(KarmProfile):
    """FD1: list (80mm bred, 7mm tykk) på begge sider av veggen.
